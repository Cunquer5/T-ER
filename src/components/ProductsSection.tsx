...
const sampleProducts = [
  ...
  { id: "f6", name: "Papaya", price: 80, image: "https://images.unsplash.com/photo-1617112848923-cc2234396a8d?auto=format&fit=crop&w=400&q=80", category: "fruits", description: "Sweet and nutritious papaya, rich in vitamins.", isOrganic: false, inStock: true },
  // Vegetables
